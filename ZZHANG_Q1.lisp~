(load "~/Documents/SBCL/Assignment 0/Q1.lisp")
...
(count-occur 'x '((x(x y (x b))) x (x y)));test case 2: s=x, lst=((x(x y (x b))) x (x y)); expected output: 5; real output: 5
(count-occur 'y '(((x y u) (x r)) (x r) ((x b y) (t x u)) (t y) y));test case 3: s=x, lst= ; expected output: 4; real output: 4
